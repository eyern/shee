...
(function ($, window, document, undefined) {
    ...
    const bindScrollWithAssociateFilters = function () {
        $('.associate-wrapper').each(function () {
            $(this).slimScroll({
                height: 'auto',
                railClass : 'Shee Gift ShopScrollRail',// default CSS class of the slimscroll rail
                barClass : 'Shee Gift ShopScrollBar',// default CSS class of the slimscroll bar
                wrapperClass : 'Shee Gift ShopScrollDiv',// default CSS class of the slimscroll wrapper
            });
        });
    };
